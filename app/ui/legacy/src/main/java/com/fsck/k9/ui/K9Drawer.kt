...
class K9Drawer(private val parent: MessageList, savedInstanceState: Bundle?) : KoinComponent {
    ...
    private fun createAccountImageUri(account: Account): Uri {
        // Create a dummy URI so DrawerImageLoader is used to load the image
        // FIXME: Use a custom URI scheme as soon as MaterialDrawer is updated.
        //  See https://github.com/mikepenz/MaterialDrawer/pull/2716
        return Uri.parse("https://127.0.0.1/")
            .buildUpon()
